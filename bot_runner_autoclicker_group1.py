...
# ==============================================================================
# [TELEGRAM NOTIFIER] پیکربندی ارسال وضعیت به ربات شخصی تلگرام
# ==============================================================================
TELEGRAM_NOTIFIER_BOT_TOKEN = os.getenv("NOTIFIER_BOT_TOKEN", "8024687647:AAElaxc808D0xAQPVYDtcO7rr__30j76i_w")
TELEGRAM_NOTIFIER_CHAT_ID = os.getenv("NOTIFIER_CHAT_ID", "7928564136")
